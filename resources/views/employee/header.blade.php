      ...
      <header class="h-15 bg-gray-200">
        <div class="flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav class="md:mr-auto flex flex-wrap items-center text-base justify-center">
            <a href = "/employee/dashboard" class = "mr-5 hover:text-gray-900">Dashboard</a>
            <a href = "/employee/application/shift/create/" class = "mr-5 hover:text-gray-900">シフト申請</a>
            <a href = "/employee/application/absence/create/" class = "mr-5 hover:text-gray-900">欠勤申請</a>
            <a href = "/employee/application/{{$employee->id}}" class = "mr-5 hover:text-gray-900">申請履歴</a>
          </nav>
