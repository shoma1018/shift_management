...
@section('content')
    <body>
        <h1 class="text-2xl text-center mt-10">ユーザー情報編集</h1>
        <form action="/employee/setting/{{$employee->id}}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-20">
                <div class="flex flex-wrap mx-60 justify-between">
                    <div class="mb-4 w-[45%]">
                        ...
                        <input type="hidden" name = "admin[multi_auth_user_id]" value = "{{ $employee->multi_auth_user_id}}"/>
                    </div>
                ...
                <div class="flex flex-wrap mx-60 justify-between">
                    ...
                    <div class="mb-4 w-[45%]">
                        ...
                        <input type="text" name="employee[email]" value = "{{ $employee->date_of_joining_company }}" class = "appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/><br>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap mx-60 justify-between">
                    <div class="mb-4 w-[45%]">
                        ...
                        <input type="text" name="employee[password]" value = "{{ $employee->employment_status }}" class = "appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"/><br>
                    </div>
                </div>
